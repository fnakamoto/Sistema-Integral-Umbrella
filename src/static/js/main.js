...
<head>
    ...
    <style>
        ...
        /* Estilos para o Modal de Follow-up */
        .modal {
        ...
        .modal-content textarea {
            min-height: 150px; /* Altura mínima para o conteúdo do e-mail */
        ...
        /* Estilos para o histórico de interações */
        .interaction-history {
            margin-top: 10px;
        ...
        #initializeTemplatesButton:hover {
...
<body>
    ...
    <div id="lead-form-container">
        ...
        <form id="lead-form">
            ...
            <div>
                ...
                <input type="number" id="lead-value" step="0.01" min="0">
            </div>
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        <button id="initializeTemplatesButton">Inicializar Templates Padrão</button>
    </div>
    ...
    <div id="followUpModal" class="modal">
        <div class="modal-content">
            ...
            <h3>Enviar Follow-up</h3>
            <p>Enviando follow-up para: <strong id="modalLeadName"></strong> (<span id="modalLeadEmail"></span>)</p>
            
            <label for="templateSelect">Selecione um Modelo:</label>
            <select id="templateSelect">
                <!-- Opções de templates serão carregadas aqui via JS -->
            </select>

            <label for="assuntoEmail">Assunto:</label>
            <input type="text" id="assuntoEmail">

            <label for="conteudoEmail">Conteúdo:</label>
            <textarea id="conteudoEmail"></textarea>

            <button id="sendFollowUpButton">Enviar Follow-up</button>
    ...
    <script>
        ...
        if (initializeTemplatesButton) {
            initializeTemplatesButton.addEventListener('click
